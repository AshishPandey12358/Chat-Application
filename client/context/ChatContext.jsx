...
export const ChatProvider = ({children}) =>{
    ...
    const [unseenMessages, setUnseenMessages] = useState({}); // have user id, number of unseen msg
    ...
    const subscribeToMessages = async() =>{
        ...
        socket.on("newMessage", (newMessage) =>{
            ...
            else{ // when new message emerges but message sender id not equal to user
                setUnseenMessages((prevUnseenMessages)=>({
                    ...prevUnseenMessages, [newMessage.senderId] :  
                    prevUnseenMessages[newMessage.senderId] ? prevUnseenMessages
                    [newMessage.senderId] +1 : 1   //check if there is already previous unseen msg if yes then just +1 else mark it as 1st
                }))
            }
        })
    }
